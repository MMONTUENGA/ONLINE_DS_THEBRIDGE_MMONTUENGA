...
def cardinalidad(df, umbral_categorica, umbral_continua):
    result_data = []
...
def colinealidad(df,target,criterio_correlacion=0.3,criterio_colinealidad=0.7,categoricas=[]):
    criterio = criterio_correlacion
    ...
    for categoria in categoricas:
        if categoria in features_num:
            features_num.remove(categoria)
    criterio_col = criterio_colinealidad
    excluidas = []
    ...
    print()
    print()
    print("Esas son las excluidas",excluidas)
